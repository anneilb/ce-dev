...
namespace Assignment1 {
    ...
    public partial class TechSupportDataSet2C : global::System.Data.DataSet {
        ...
        public partial class IncidentsDataTable : global::System.Data.TypedTableBase<IncidentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public IncidentsRow AddIncidentsRow(CustomersRow parentCustomersRowByFK_Incidents_Customers, ProductsRow parentProductsRowByFK_Incidents_Products, System.DateTime DateOpened, System.DateTime DateClosed, string Title, string TechnicianName, string CustomerName, int TechID) {
                ...
                if ((parentCustomersRowByFK_Incidents_Customers != null)) {
                    columnValuesArray[0] = parentCustomersRowByFK_Incidents_Customers[0];
                }
                if ((parentProductsRowByFK_Incidents_Products != null)) {
                    columnValuesArray[1] = parentProductsRowByFK_Incidents_Products[0];
                }
...
namespace Assignment1.TechSupportDataSet2CTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int Fill(TechSupportDataSet2C.CustomersDataTable dataTable, int customerID) {
    ...
    public partial class IncidentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT     Incidents.IncidentID, Incidents.TechID, Incidents.CustomerID, Incidents.ProductCode, Incidents.DateOpened, Incidents.DateClosed, Incidents.Title, 
                      Technicians.Name AS TechnicianName, Customers.Name AS CustomerName
FROM         Incidents INNER JOIN
                      Customers ON Incidents.CustomerID = Customers.CustomerID LEFT OUTER JOIN
